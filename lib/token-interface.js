...
var tokenContractJSON = require('../app/assets/contracts/_BitcoinClassicToken.json');
...
module.exports =  {
 ...
 async  update()
  ...
  getTokenContractAddress()
  {
    ...
    {
      return deployedContractInfo.networks.testnet.contracts._bitcoinclassictoken.blockchain_address;
    }else{
      return deployedContractInfo.networks.mainnet.contracts._bitcoinclassictoken.blockchain_address;
    }
