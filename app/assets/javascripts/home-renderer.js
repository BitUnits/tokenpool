    ...
    init( )
    {
      ...
      var transfer_list = [];
        ...
        for(var i in data )
        {
          ...
          if(data[i].txHash){
            data[i].txURL = ("https://etherhub.io/tx/"+ data[i].txHash.toString());
          }
      ...
      //  self.accountListData.minerAccountData = data;
        ...
        data.etherhubMintingURL = "https://etherhub.io/addr/"+data.mintingAddress.toString();
        data.etherhubPaymentURL = "https://etherhub.io/addr/"+data.paymentAddress.toString();


          Vue.set(jumbotron.pool, 'poolData',  data )

      //  Vue.set(jumbotron.pool, 'etherhubMintingURL',  etherhubMintingURL )
      //  Vue.set(jumbotron.pool, 'etherhubPaymentURL',  etherhubPaymentURL )
